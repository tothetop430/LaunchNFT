...
export const CallMe = async ({val, payer_json_path}) => {
    //////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////
    ...
    // const payer = process.env?.payer_json_path
    //     ? loadKeypairFromFile(process.env?.payer_json_path)
    //     : loadOrGenerateKeypair("payer");
    const payer = loadKeypairFromFile(payer_json_path);
    // const payer = process.env;
    ...
    */
    ...
    // const collectionMetadataV3: CreateMetadataAccountArgsV3 = val;
    ...
    */
    ...
    const res = await mintCompressedNFT(
        connection,
        payer,
        treeKeypair.publicKey,
        collection.mint,
